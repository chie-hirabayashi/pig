...
excel_db_map = {
    "day": {
        ...
        "column": {
            ...
            "pub_datetime": {"type": "text", "index": 16},
        },
    },
    "number": {
        "min_row": 2,
        ...
        "column": {
            ...
            "pub_datetime": {"type": "text", "index": 15},
        },
    },
}
...
def db_insert(book, db_map):
    ...
    dbname = os.path.join(current_dir, "pig.sqlite")
...
wb = excel.load_workbook("/Users/admin/camp/Day08/db.xlsx", data_only=True)
